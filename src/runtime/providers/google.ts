...
import { normalizeSchema, stripAdditionalProperties } from "../schema-middleware.js";
      ...
      `https://generativelanguage.googleapis.com/v1beta/models/${model}:generateContent`,
      {
        ...
        body: JSON.stringify({
          ...
          generationConfig: {
            ...
            ...(options?.jsonSchema ? { responseSchema: stripAdditionalProperties(normalizeSchema(options.jsonSchema.schema)) } : {}),
          },
        }),
      },
    );
